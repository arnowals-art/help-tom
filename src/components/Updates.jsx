...
export const UPDATES = [
  {
    ...
    text: <>
      <p>Tom is inmiddels terug uit Israël. De behandeling is goed verlopen.</p>
      <p>Uit de onderzoeken blijkt dat de behandeling goed lijkt aan te slaan: er zijn verbeteringen in de bloedwaarden te zien.</p>
      <p>Vanaf nu wordt Tom verder behandeld in het Radboudumc. Hopelijk wordt de verbetering de komende maanden steeds beter zichtbaar.</p>
    </>,
  },
  {
    date: '24 juli 2026',
